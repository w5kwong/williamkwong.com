            ...
            <div class="container">
                <div class="row justify-content-start">
                    <div class="col-lg">
                        ...
                        <p class="text-left">Shoot me an email if you'd like to grab coffee! I'm always looking to find interesting and new perspectives from people I've never met.</p>
                    </div>
                    <div class="col-lg">
                        <h5>Skills</h5>
                        <ul>
